...
contains
  ...
  subroutine formfactors_Delta(Qs,W,processID,c3v,c4v,c5v,c6v,c3a,c4a,c5a,c6a)
    ...
    case (NC,antiNC)
       ...
       if (.not. (justSMpNSIee .or. justNSImue .or. justNSIetau .or. justSMpNSImumu .or. justNSImutau .or. justSMpNSItautau)) then
         c3v=c3v*(1.-2.*sinsthweinbg)
         c4v=c4v*(1.-2.*sinsthweinbg)
         c5v=c5v*(1.-2.*sinsthweinbg)
       end if
       if (justSMpNSIee) c3v=c3v*(1.-2.*sinsthweinbg+epVuee-epVdee)
       if (justSMpNSIee) c4v=c4v*(1.-2.*sinsthweinbg+epVuee-epVdee)
       if (justSMpNSIee) c5v=c5v*(1.-2.*sinsthweinbg+epVuee-epVdee)
       if (justNSImue) c3v=c3v*(epVumue-epVdmue)
       if (justNSImue) c4v=c4v*(epVumue-epVdmue)
       if (justNSImue) c5v=c5v*(epVumue-epVdmue)
       if (justNSIetau) c3v=c3v*(epVuetau-epVdetau)
       if (justNSIetau) c4v=c4v*(epVuetau-epVdetau)
       if (justNSIetau) c5v=c5v*(epVuetau-epVdetau)
       if (justSMpNSImumu) c3v=c3v*(1.-2.*sinsthweinbg+epVumumu-epVdmumu)
       if (justSMpNSImumu) c4v=c4v*(1.-2.*sinsthweinbg+epVumumu-epVdmumu)
       if (justSMpNSImumu) c5v=c5v*(1.-2.*sinsthweinbg+epVumumu-epVdmumu)
       if (justNSImutau) c3v=c3v*(epVumutau-epVdmutau)
       if (justNSImutau) c4v=c4v*(epVumutau-epVdmutau)
       if (justNSImutau) c5v=c5v*(epVumutau-epVdmutau)
       if (justSMpNSItautau) c3v=c3v*(1.-2.*sinsthweinbg+epVutautau-epVdtautau)
       if (justSMpNSItautau) c4v=c4v*(1.-2.*sinsthweinbg+epVutautau-epVdtautau)
       if (justSMpNSItautau) c5v=c5v*(1.-2.*sinsthweinbg+epVutautau-epVdtautau)
       ...
       if (justSMpNSIee) c3a=c3a*(1.-epAuee+epAdee)
       if (justSMpNSIee) c4a=c4a*(1.-epAuee+epAdee)
       if (justSMpNSIee) c5a=c5a*(1.-epAuee+epAdee)
       if (justSMpNSIee) c6a=c6a*(1.-epAuee+epAdee)
       if (justNSImue) c3a=c3a*(-epAumue+epAdmue)
       if (justNSImue) c4a=c4a*(-epAumue+epAdmue)
       if (justNSImue) c5a=c5a*(-epAumue+epAdmue)
       if (justNSImue) c6a=c6a*(-epAumue+epAdmue)
       if (justNSIetau) c3a=c3a*(-epAuetau+epAdetau)
       if (justNSIetau) c4a=c4a*(-epAuetau+epAdetau)
       if (justNSIetau) c5a=c5a*(-epAuetau+epAdetau)
       if (justNSIetau) c6a=c6a*(-epAuetau+epAdetau)
       if (justSMpNSImumu) c3a=c3a*(1.-epAumumu+epAdmumu)
       if (justSMpNSImumu) c4a=c4a*(1.-epAumumu+epAdmumu)
       if (justSMpNSImumu) c5a=c5a*(1.-epAumumu+epAdmumu)
       if (justSMpNSImumu) c6a=c6a*(1.-epAumumu+epAdmumu)
       if (justNSImutau) c3a=c3a*(-epAumutau+epAdmutau)
       if (justNSImutau) c4a=c4a*(-epAumutau+epAdmutau)
       if (justNSImutau) c5a=c5a*(-epAumutau+epAdmutau)
       if (justNSImutau) c6a=c6a*(-epAumutau+epAdmutau)
       if (justSMpNSItautau) c3a=c3a*(1.-epAutautau+epAdtautau)
       if (justSMpNSItautau) c4a=c4a*(1.-epAutautau+epAdtautau)
       if (justSMpNSItautau) c5a=c5a*(1.-epAutautau+epAdtautau)
       if (justSMpNSItautau) c6a=c6a*(1.-epAutautau+epAdtautau)
